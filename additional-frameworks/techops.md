...
topics:
  ...
  - name: "knowledge"
    ...
    content:
      ...
      - level: 5
        criteria:
          - "Constantly innovating, learning, teaching and looking for new ways to do things which haven't been done before. Shares these new ways of doing things internally and externally. Is a recognised industry expert outside of Interact."
    ...
    content:
      - level: 1
        criteria:
          ...
          - "Brings new ideas to the table to improve technical aspects of Interactnaut’s day to day life"
      - level: 2
        criteria:
      ...
      - level: 5
        criteria:
          - "Represents Interact at conferences/events"
          - "Given as a reason for other engineers to join Interact"
  ...
  - name: "leadership"
    ...
    content:
      ...
      - level: 4
        criteria:
          - "Contributes to maintaining the Interact culture in their team, helping new joiners"
          - "Gets buy-in on technical decision-making and proposed designs"
          - "Proactively involves other relevant engineers"
          - "Instills Interact engineering principles into the team, even for operational tasks"
      ...
      - level: 5
        criteria:
          - "Instills Interact engineering principles across a whole squad of engineers"
          ...
          - "Contributes to maintaining the Interact culture in the wider company"
