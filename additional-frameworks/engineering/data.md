    ...
    content:
      ...
      - level: 4
        criteria:
          ...
          - "Instills Interact engineering principles in other engineers"
    ...
    content:
      ...
      - level: 5
        criteria:
          ...
          - "Given as reason for other engineers to join Interact"
    ...
    content:
      ...
      - level: 5
        criteria:
          ...
          - "Contributes to maintaining Interact’s culture in the wider company"
...
- Mastery - Your Interact knowledge and technical capability
